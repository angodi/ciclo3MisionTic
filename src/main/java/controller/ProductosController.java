...
public class ProductosController implements IPeliculaController {
    ...
    public String listar(boolean ordenar, String orden) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Productos producto = new Productos(idproducto, material, descripcion, precio, unidades, categoria, tiempoentrega);
